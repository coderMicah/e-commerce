    ...
    <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
      ...
      <div>
        <div className="mt-10">
            ...
            <div className="absolute transform sm:left-1/2 sm:top-0 sm:translate-x-8 lg:left-1/2 lg:top-1/2 lg:-translate-y-1/2 lg:translate-x-8">
              <div className="flex items-center space-x-6 lg:space-x-8">
                ...
                <div className="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                  ...
                  <div className="h-64 w-44 overflow-hidden rounded-lg">
                    <img src="/home04.jpg" alt="" className="h-full w-full object-cover object-center"></img>
                  </div>
                  <div className="h-64 w-44 overflow-hidden rounded-lg">
                    <img src="/home05.jpg" alt="" className="h-full w-full object-cover object-center"></img>
                  </div>
                </div>
                <div className="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                  <div className="h-64 w-44 overflow-hidden rounded-lg">
                    <img src="/home06.jpg" alt="" className="h-full w-full object-cover object-center"></img>
                  </div>
                  <div className="h-64 w-44 overflow-hidden rounded-lg">
                    <img src="/home07.jpg" alt="" className="h-full w-full object-cover object-center"></img>
                  </div>
                </div>
              </div>
            </div>
          ...
          <a href="/Cart" className="inline-block rounded-md border border-transparent bg-indigo-600 py-3 px-8 text-center font-medium text-white hover:bg-indigo-700">Shop Collection</a>
        </div>
      </div>
    </div>
  </div>
